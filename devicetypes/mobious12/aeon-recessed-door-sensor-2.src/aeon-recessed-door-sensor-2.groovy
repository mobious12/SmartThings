...
metadata {
	...
	definition (name: "Aeon Recessed Door Sensor 2", namespace: "mobious12", author: "Mike Barry") {
		capability "Contact Sensor"
		capability "Sensor"
		capability "Battery"
     	//updated and added fingerprint definitions - Glen
